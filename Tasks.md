...
- [ ] **A-2. `test_15_cli_api_server.py` の拡充:**
...
- [ ] **A-3. `test_13_cli_api_client.py` の拡充:**
...
- [ ] **A-4. `test_14_cli_str_client.py` の拡充:**
...
- [ ] **A-5. `test_16_cli_api_cli.py` の拡充:**
...
- [ ] **A-6. `test_17_cli_str_cli.py` の拡充:**
...
- [ ] **B-1. `test_01_piservo.py` の拡充:**
    - `pigpio` の操作でエラーが発生した場合の `PiServo` の振る舞い（例: 例外処理、フォールバック）を検証するテストを追加する。
- [ ] **B-2. `test_02_servo_config_manager.py` の拡充:**
...
- [ ] **B-3. `test_05_threadworker.py` の拡充:**
...
- [ ] **C-1. `test_06_str_cmd_to_json.py` の拡充:**
...
- [ ] **D-1. `test_07_threadworker_send_recv.py` の役割明確化と拡充:**
